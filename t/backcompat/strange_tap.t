...
is($harness->parsed_report->{report_meta}{'suite-name'},    'Tapper-CTCS',             "report meta suite name");
...
is($first_section->{section_name},'tapper-meta-information', "first section name");

is($first_section->{section_meta}{'suite-name'},             'Tapper-CTCS', "report meta suite name");
